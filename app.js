...
// Data
var self = this;
self.filters = ['atm', 'cafe', 'parking', 'pharmacy','restaurant','gas_station','gym','store'];


self.chosenType=ko.observable();
self.locations=ko.observableArray();
  //var highlightedIcon = makeMarkerIcon('FFFF24');
self.highlightMarker=function(m){
  m.click();
};
...
ko.applyBindings(myViewModel);
  ...
  var service;
  var myType;
  var locations=[];//通过筛选搜索出的地址列表

//$(".btn").on("click",function(){
//  myViewModel.highlightMarker().setIcon(highlightedIcon);
//});
